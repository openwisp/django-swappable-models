...
- Add or update focused tests for every behavior change. For bug fixes, first reproduce the failure with a regression test when the repository's test setup allows it.
